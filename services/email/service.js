...
class EmailService {
  constructor(env, sender) {
    ...
    switch (env) {
      case 'development':
        this.link = 'https://c91c-92-118-76-163.ngrok.io';
        break;
      case 'production':
  ...
  createTemplateEmail(name, verifyToken) {
    ...
    const email = {
      body: {
        name,
        intro:
          "Welcome to Andrii's Company We're very excited to have you on board.",
        action: {
          instructions:
            "To get started with Andrii's Company, please click here:",
          button: {
